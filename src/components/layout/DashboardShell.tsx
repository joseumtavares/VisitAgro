...
const NAV_ITEMS: NavItem[] = [
  ...
  // L040.1: Controle de KM — visível para todos os perfis; API bloqueia com 403 se necessário
  { href: '/dashboard/km',               label: 'Controle de KM',      icon: <Car             className="w-4 h-4" /> },
];
