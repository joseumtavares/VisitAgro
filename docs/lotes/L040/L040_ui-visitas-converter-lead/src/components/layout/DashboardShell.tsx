...
import {
  ...
  Menu,
  X,
  CalendarCheck2, // L040: ícone para Visitas — CalendarCheck2 existe em lucide-react >=0.263
} from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  // L040: Histórico de Visitas — UI criada neste lote; API GET /api/visits já existia
  { href: '/dashboard/visits',           label: 'Visitas',             icon: <CalendarCheck2  className="w-4 h-4" /> },
